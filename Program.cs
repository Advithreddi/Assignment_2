    ...
    class Program
    {
        ...
        public static IList<int> MoveZeroes(int[] nums)
        {
            try
            {
                ...
                for (int i = 0; i < nums.Length; i++)
                {
                    ...
                    if (nums[i] != 0)
                    {
                        nums[nonZeroIndex++] = nums[i]; // Move the non-zero element to the next non-zero position
                    }
                }
        ...
        */
        ...
        public static int BinaryToDecimal(int binary)
        {
            ...
            while (binary != 0)
            {
                ...
                // Move to the next position in the binary number and update the base value
                binary = binary / 10;
                baseValue *= 2;
            }
            ...
            try
            {
                ...
                for (int i = nums.Length - 1; i >= 2; i--)
                {
                    ...
                    if (nums[i - 2] + nums[i - 1] > nums[i])
                        // If the condition satisfies, return the perimeter of the triangle
        ...
        */
        ...
        public static string RemoveOccurrences(string s, string part)
        {
            ...
            {
                {
                    // Loop until the part is found in the string
